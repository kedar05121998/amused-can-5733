...
function Polictics(){
    ...
    useEffect(()=>{
        ...
        axios.get(`https://newsapi.org/v2/everything?q=politics&from=2023-02-10&sortBy=publishedAt&apiKey=27532f5e99e948da97e7b6d6f30a4302&pageSize=30`)
        .then((res)=>{
